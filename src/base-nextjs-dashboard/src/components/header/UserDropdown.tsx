...
import ChangeMyPasswordModal from "@/components/profile/ChangeMyPasswordModal";
...
export default function UserDropdown() {
  ...
  const handleChangePassword = async (oldPassword: string, newPassword: string) => {
    try {
      ...
      toast.success(t("profile.changePassword.messages.success"));
      setShowChangePasswordModal(false);
    } catch (error: unknown) {
      const errorMessage = error instanceof Error ? error.message : t("profile.changePassword.messages.failed");
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
          ...
          <li>
            ...
            >
              ...
              {t("profile.changePassword.menuItem")}
            </DropdownItem>
          </li>
        </ul>
        <button
